...
C######################################################################C
		...
		Real*8 CL,CLD,V,Vp,Emax,EC50,kon,kdeg,koff,ksyn,IC50
C----------------------------------------------------------------------C
...
C----c-----------------------------------------------------------------C
		 ...
		 XP(1)= R(1)-(CL/V+CLD/V)*X(1)+CLD*X(2)/Vp
		 XP(2)= -CLD*X(2)/Vp+CLD*X(1)/V
		 XP(3)= ksyn*(1-(X(4)/(IC50+X(4))))-ksyn*X(3)
		 XP(4)= kon*X(1)*X(3)/V-koff*X(4)
...
C######################################################################C
        ...
        Real*8 Y(MaxNOE),T,X(MaxNDE),V,Emax,EC50
