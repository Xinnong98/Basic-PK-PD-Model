...
C######################################################################C
		...
		Real*8 cl,cld,v2,V1,ti,kon,koff,Emax
C----------------------------------------------------------------------C
...
C----c-----------------------------------------------------------------C
		...
		XP(10) = kon*X(2)/V1*(Emax-X(10))-(koff*X(10))
		XP(11) = kon*X(5)/V1*(Emax-X(11))-(koff*X(11))
		XP(12) = kon*X(8)/V1*(Emax-X(12))-(koff*X(12))
