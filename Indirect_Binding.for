...
C######################################################################C
		...
		Real*8 cl,cld,v2,V1,ti,kin,Im,IC50,ga
C----------------------------------------------------------------------C
...
C----c-----------------------------------------------------------------C
		...
		XP(10) = kin*(1-(Im*(X(2)/V1)**ga/(IC50**ga+(X(2)/V1)**ga)))-
     c             kin/IC(10)*X(10)
		XP(11) = kin*(1-(Im*(X(5)/V1)**ga/(IC50**ga+(X(5)/V1)**ga)))-
     c             kin/IC(11)*X(11)
		XP(12) = kin*(1-(Im*(X(8)/V1)**ga/(IC50**ga+(X(8)/V1)**ga)))-
     c             kin/IC(12)*X(12)
