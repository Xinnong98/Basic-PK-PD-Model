...
C######################################################################C
		...
		Real*8 CL,CLD,Vc,Vp,SM,SC50,K0,KP,KT,KOUT
C----------------------------------------------------------------------C
...
C----c-----------------------------------------------------------------C
		CL=P(1)
		 ...
		 XP(1) = R(1)-(CL+CLD)/Vc*X(1)+CLD/Vp*X(2)
		 XP(2) = -CLD/Vp*X(2)+CLD*X(1)/Vc
		
		 XP(3)=K0-(Kp*(1+(Sm*X(1)/Vc/(SC50+(X(1)/vc)))))*X(3)
		 XP(4)=kp*(1+(Sm*X(1)/Vc/(SC50+(X(1)/Vc))))*X(3)*(1-kt*X(5))-
     c      Kout*X(4)
		 XP(5)=kt*X(4)-kt*X(5)
C----------------------------------------------------------------------C
C----------------------------------------------------------------------C
