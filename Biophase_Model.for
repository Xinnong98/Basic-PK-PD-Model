...
C----c-----------------------------------------------------------------C
      ...
      NDEqs   =  12   ! Enter # of Diff. Eqs.
      NSParam =  9   ! Enter # of System Parameters.
...
C######################################################################C
		...
		Real*8 cl,cld,v2,v1,KEO,EMAX,EC,ti
C----------------------------------------------------------------------C
...
C----c-----------------------------------------------------------------C
		...
		XP(10) = KEO*(X(2)/V1-X(10))
		XP(11) = KEO*(X(5)/V1-X(11))
		XP(12) = KEO*(X(8)/V1-X(12))
...
C######################################################################C
        ...
        Real*8 Y(MaxNOE),T,X(MaxNDE),V1,EMAX,EC,ga
...
C----c-----------------------------------------------------------------C
		...
		Y(4) = 6.92*(1-EMAX*(X(10)**ga)/(EC**ga+(X(10)**ga)))
		Y(5) = 6.92*(1-EMAX*(X(11)**ga)/(EC**ga+(X(11)**ga)))
		Y(6) = 6.92*(1-EMAX*(X(12)**ga)/(EC**ga+(X(12)**ga)))
